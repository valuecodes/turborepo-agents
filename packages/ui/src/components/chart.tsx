            ...
            return (
              ...
              >
                {formatter && item.value !== undefined && item.name ? (
                  // eslint-disable-next-line @typescript-eslint/no-unsafe-argument -- recharts payload types
    ...
    >
      {payload
        ...
        .map((item) => {
          ...
          const itemConfig = getPayloadConfigFromPayload(config, item, key);
          // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- recharts payload types
